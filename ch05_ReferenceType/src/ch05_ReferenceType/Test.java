...
public class Test {
	public static void main(String[] args) {
         //String 객체의 비교
      {
          ...
          String str4 = "Hello"; // heap 300 주소에 있는 문자열 사용 string pool 공유
          ...
          // equals():heap 위치와 상관없이 문자열 내용 비교
...
//          System.out.println(mc1.equals(mc2)); // false <= 같은 참조 타입의 객체가 무조건 equals() 로 내용비교가 true 가 되는 건 아니다.
        ...
        // String 의 다양한 메소드
        {
            ...
            // charAt()
            System.out.println(str.charAt(0)); // H 범위를 벗어 나면 StringIOBE 발생
            
            // replace()
            System.out.println(str.replace("l", "X")); // 새로운 문자열 return HeXXo
            ...
            System.out.println(str.substring(0, str.indexOf("l")) + "X" + str.substring(str.indexOf("l") + 1, str.length()));//HeXlo
        }
